...
from mgpt.constants.transforms import SMPLH_PATH, GLOBAL_VELHANDY_PATH
...
class SMPLTransform(Transform):
    def __init__(
        self,
        batch_size=16,
        rots2rfeats: Rots2Rfeats = None,
        rots2joints: Rots2Joints = None,
        joints2jfeats: Joints2Jfeats = None,
        **kwargs,
    ):
        if rots2rfeats is None:
            rots2rfeats = Globalvelandy(
                path=str(GLOBAL_VELHANDY_PATH.joinpath("separate_pairs")),
                normalization=True,
                pose_rep="rot6d",
                canonicalize=True,
                offset=True,
