...
from mgpt.constants.transforms import JOINTS2JFEATS_DIR

# from teach.tools.geometry import matrix_of_angles
from .base import Joints2Jfeats
from mgpt.data_loaders.amass.tools_teach.geometry import matrix_of_angles
