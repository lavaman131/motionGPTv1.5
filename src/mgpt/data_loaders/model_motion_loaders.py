...
from mgpt.data_loaders.datasets_composition import CompMDMUnfoldingGeneratedDataset
...
def get_mdm_loader(
    ...
    dataset = CompMDMUnfoldingGeneratedDataset(
        args,
        model,
        diffusion,
        max_motion_length,
        eval_file,
        w_vectorizer=dataset.w_vectorizer,
        opt=dataset.opt,
