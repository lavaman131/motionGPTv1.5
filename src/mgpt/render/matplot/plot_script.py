...
def plot_3d_motion_multicolor(
    ...
    def update(index):
        ...
        used_colors = (
            colors_dict[frame_colors[index]]
            if (index < len(frame_colors))
            else colors_dict["blue"]
        )
...
def plot_3d_motion_multicolor_pdf(
    save_path,
    kinematic_tree,
    joints,
    title,
...
def save_multiple_samples(
    num_repetitions, out_path, row_print_template, row_file_template, rep_files
):
