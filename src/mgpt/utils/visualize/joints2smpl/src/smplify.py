...
from mgpt.constants.amass.joint_maps import (
    JOINT_MAP,
    AMASS_JOINT_MAP,
    full_smpl_idx,
    amass_idx,
...
from mgpt.constants.transforms import GMM_MODEL_DIR, PART_SEG_DIR
...
class SMPLify3D:
    ...
    def __init__(
        ...
        self.pose_prior = MaxMixturePrior(
            prior_folder=str(GMM_MODEL_DIR), num_gaussians=8, dtype=torch.float32
        ).to(device)
        # collision part
