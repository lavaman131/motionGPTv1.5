...
def parse_and_load_from_model(parser, update_args=True):
    ...
    if update_args:
        ...
        assert os.path.exists(
            args_path
        ), f"Arguments json file was not found! {args_path}"
...
def add_model_options(parser):
    ...
    group.add_argument(
        ...
        default=0.0,
        type=float,
        help="Joint velocity loss (representation space).",
    )
    group.add_argument(
    ...
    group.add_argument(
        ...
        default=0.0,
        type=float,
        help="Joint velocity loss (position space).",
    )
    group.add_argument(
        "--unconstrained",
        action="store_true",
...
def add_data_options(parser):
    ...
    group.add_argument(
        "--pose_rep", default="rotvec", type=str, choices=["hml_vec", "rot6d"]
    )
...
def add_training_options(parser):
    ...
    group.add_argument("--wandb_project", type=str, help="Wandb project name.")
    group.add_argument("--wandb_entity", type=str, help="Wandb entity name.")
    group.add_argument(
        "--overwrite",
        action="store_true",
    ...
    group.add_argument(
        "--train_platform_type",
        default="NoPlatform",
        choices=["NoPlatform", "TensorboardPlatform", "WandbPlatform"],
        type=str,
...
def add_evaluation_options(parser):
    ...
    group.add_argument(
        ...
        type=str,
        help="fast - 3 repetitions. " "debug - 1 repetition." "final - 10 repetitions.",
    )
    group.add_argument(
        "--guidance_param",
        default=2.5,
    ...
    group.add_argument(
        "--scenario", default="", type=str, help="name of the scenario to be evaluated"
    )
    group.add_argument(
        "--extrapolation", action="store_true", help="evaluate extrapolation"
    )
