from mgpt.model.FlowMDM import FlowMDM
from mgpt.diffusion import gaussian_diffusion as gd
from mgpt.diffusion.respace import SpacedDiffusion, space_timesteps
from mgpt.utils.parser_util import get_cond_mode
from mgpt.model.cfg_sampler import wrap_model
import torch


def load_model(
    args, device, cond_mode=None, ModelClass=FlowMDM, DiffusionClass=SpacedDiffusion
):
    model, diffusion = create_model_and_diffusion(
        args, cond_mode=cond_mode, ModelClass=ModelClass, DiffusionClass=DiffusionClass
    )
...
def load_model_wo_clip(model, state_dict):
    ...
    to_remove = [
        "t_pos_encoder.pe",
        "seqTransEncoder.attn_layers.rotary_pos_emb.last_timestep",
    ]
...
def create_model_and_diffusion(
    args, cond_mode=None, ModelClass=FlowMDM, DiffusionClass=SpacedDiffusion
):
