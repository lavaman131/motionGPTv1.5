...
def fast_render(data, output_path, dataset="babel"):
...
def slow_render(all_motions, output_path, smpl_model_path):
...
if __name__ == "__main__":
    ...
    if method == "slow":
        slow_render(all_motions, output_path, smpl_model_path)

    elif method == "fast":
        fast_render(data, output_path, dataset=dataset)
